    ...
    const data = [
        {
            ...
            tabContent: <div className="wrapper web">
                <img src="\img\service.jpg"className="web-image" alt="logo" />
        ...
        },
        {
            ...
            tabContent: <p className="design-txt"> Graphic design is a craft where professionals create visual content to communicate messages. By applying visual hierarchy and page layout techniques, designers use typography and pictures to meet users specific needs and focus on the logic of displaying elements in interactive designs, to optimize the user experience.</p>
        },
        {
            id: '3',
            tabTitle: "Online Support",
            tabContent: <p className="design-txt">Online help is the help file accessible for software applications or operating systems. It provides information relating to general operation of the program as well as troubleshooting. Online help can help customers resolve their issues without having to contact a customer service representative, saving time and effort.</p>
        },
        {
            id: '4',
            tabTitle: "App Design",
            tabContent: <p className="design-txt">App design combines the user interface (UI) and user experience (UX). While UI lends itself to the overall style of the app (including the colors, fonts, and general look and feel), UX focuses on the actual functionality and usability. A large number of users abandon an app after using it for the first time. Since users are picky about which apps they use and so quick to abandon those they don’t enjoy, it’s essential to invest time and effort in creating a great user experience. The better the design, the better the chance that a user will engage with it and thus keep using it.</p>
        },
        {
            id: '5',
            tabTitle: "Online Marketing",
            tabContent: <p className="design-txt">Online marketing is the practice of leveraging web-based channels to spread a message about a companys brand, products, or services to its potential customers. The methods and techniques used for online marketing include email, social media, display advertising, search engine optimization, </p>
        },
        {
            id: '6',
            tabTitle: "Seo Service",
            tabContent: <p className="design-txt">Search engine optimization (SEO) is the process of improving the quality and quantity of website traffic to a website or a web page from search engines. SEO targets unpaid traffic (known as "natural" or "organic" results) rather than direct traffic or paid traffic.</p>
        }
    ]
    return (
